...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btnLogout.setGeometry(QtCore.QRect(390, 280, 81, 41))
...
"}")
        ...
        self.tblSchedule = QtWidgets.QTableWidget(self.centralwidget)
        self.tblSchedule.setEnabled(True)
        self.tblSchedule.setGeometry(QtCore.QRect(10, 80, 691, 191))
...
"}")
        ...
        # self.tblSchedule.horizontalHeader().setSectionResizeMode(QHeaderView.Stretch)
        self.tblSchedule.horizontalHeader().setDefaultAlignment(Qt.AlignCenter)
        self.lbUser = QtWidgets.QLabel(self.centralwidget)
        self.lbUser.setGeometry(QtCore.QRect(620, 10, 81, 21))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lbUser.setText(_translate("MainWindow", "TextLabel"))
